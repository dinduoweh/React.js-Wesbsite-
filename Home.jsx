    ...
    <>
      <section className="hero">
        <div className="container">
          <h1 style={{fontSize: '4rem', fontWeight: 800, margin: 0, lineHeight: 1.1}}>
            Pushing<br />
            machines to
          </h1>
          <div style={{fontSize: '3rem', fontStyle: 'italic', fontWeight: 400, margin: '16px 0 32px 0', color: '#444'}}>
            brilliance.
          </div>
          <p style={{fontSize: '1.15rem', color: '#444', maxWidth: 800, marginBottom: 32}}>
          ...
          <p style={{fontSize: '1.08rem', color: '#444', maxWidth: 900}}>
            Research <a href="#" style={{textDecoration:'underline'}}>@NASA <span className="ext">↗</span></a>. Prev AI/ML Intern <a href="#" style={{textDecoration:'underline'}}>@Apple <span className="ext">↗</span></a>. Prev ML Systems Research <a href="#" style={{textDecoration:'underline'}}>@NAVSEA <span className="ext">↗</span></a>. Lead Student Researcher <a href="#" style={{textDecoration:'underline'}}>@Tarleton State - Machine Intelligence Security and Research Lab <span className="ext">↗</span></a>, Computational Modelling Researcher <a href="#" style={{textDecoration:'underline'}}>@TIAER – Texas Insititute Applied For Environment Research <span className="ext">↗</span></a>.
          </p>
        </div>
      </section>

      {/* Contact block duplicated here so it's visible at the bottom of the Home page */}
        ...
        <div className="contact-inner">
          ...
          <div className="contact-block">
            ...
            <div className="emails">
              <a href="mailto:Chimdindu.oweh@mytwu.ca">Chimdind.oweh@mytwu.ca</a>
